...
Interface & UI: Designed with a simplified UI, and an app/mobile interface. It features LED status indicators and pulsing LEDs to show readiness and battery status.
